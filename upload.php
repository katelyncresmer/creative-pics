...
$results=run_my_query("SELECT * FROM stream WHERE username='$user'");
?><!DOCTYPE html>
<html>
<head>
<meta charset="utf-8"/>
...
<h1 id="dashh">Upload a Picture</h1>
<form  action='process-add-picture.php' method="post" enctype="multipart/form-data">
    	
        <p>Picture:<input class="inputadd" type="file" name="newpic" required></p>
        <p>Caption:<br><textarea class="inputadd" name="newcap"></textarea>
